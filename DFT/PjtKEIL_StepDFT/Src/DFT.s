...
DFT_ModuleAuCarre PROC; short int * Signal64ech, char k
	push{r4,r5,r6,r7}
	mov r2, #0 ;r2 indice n
	
	mov r3, #64 ;r3 longueur du tableau
	;mov r7, #63 ; r7 == masque de longueur tableau
	mov r7, #0 ; r9 = somme des partie réelle 
	mov r6, #0
	ldr r5,=TabCos
...
Loop
	...
	;Operation modulo
	mul r6,r1,r2 ;r6 = k*n 
	and r6, #63 ;r5 = k*n AND LongueurTableau = k*n % LongueurTableau
	push {r3}
	ldrsh r3, [r5,r6,lsl #1] ; r3 = cos à l'indice r6 ; r3 format 1.15
	asr r3, #2 ;1.13
	ldrsh r4, [r0,r2,lsl #1] ; r4 = signal à l'indice r2 1.12
	asr r4, #2 ;1.10 
	mla r7, r3, r4, r7 ; 8.23
	pop{r3}
	add r2, #1 
